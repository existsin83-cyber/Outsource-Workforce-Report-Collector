...
class SettingsDialog(QDialog):
    ...
    def _build_employee_tab(self) -> QWidget:
        ...
        add_button.clicked.connect(lambda _checked=False: self.add_employee_row())
    ...
    def _build_vendor_tab(self) -> QWidget:
        ...
        remove_button = QPushButton("선택 삭제")
        add_button.clicked.connect(lambda _checked=False: self.add_vendor_row())
    ...
    def _build_work_order_tab(self) -> QWidget:
        ...
        remove_button = QPushButton("선택 삭제")
        add_button.clicked.connect(lambda _checked=False: self.add_work_order_row())
